function [hImage, hText, hXText, p] = heatmap(mat, xlab, ylab, textmat, varargin)
...
%
% * "textmat" can either be: 1 (for true), in which case the "matrix" values will be
...
if isempty(xlab)
    ...
    %if isnumeric(xlab) %% Turned this off to make the x-axis tic marks better
    ...
    if p.TickAngle == 0
        ...
        set(p.hAxes,'XTick',xtick,'XTickLabel',0:50:xlab(end));
    else
