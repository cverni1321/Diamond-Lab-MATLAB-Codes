function [P,T,p,t,s,s_normalized] = GetSynergyScores(expt,flag,varargin)

% Use this script to calculate synergy scores for PAS experiments
...
for i = 1:num_wells
   time = expt.samewells(i).time*timescale;
   data = expt.samewells(i).data;
   num_rep = size(data,2);
